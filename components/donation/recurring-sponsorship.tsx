...
export function RecurringSponsorships() {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose your own monthly contribution amount</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Your custom sponsorship helps us provide flexible support where it's needed most.
            </p>
          </div>
        </CardContent>
        <CardFooter>
          <Button className="w-full" disabled={!customAmount || Number.parseInt(customAmount) < 100}>
            Start Custom Sponsorship
          </Button>
        </CardFooter>
      </Card>
    </div>
